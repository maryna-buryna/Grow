...
/***/ function(module, exports, __webpack_require__) {
	...
	var _helperService = __webpack_require__(9);
	
	var _helperService2 = _interopRequireDefault(_helperService);
	
	var _urlConfig = __webpack_require__(10);
	
	var _urlConfig2 = _interopRequireDefault(_urlConfig);
	
	var _articleTpl = __webpack_require__(11);
	
	var _articleTpl2 = _interopRequireDefault(_articleTpl);
	
	var _tagTpl = __webpack_require__(12);
	
	var _tagTpl2 = _interopRequireDefault(_tagTpl);
	
	var _simpleTagTpl = __webpack_require__(13);
	
	var _simpleTagTpl2 = _interopRequireDefault(_simpleTagTpl);
	
	var _pageTpl = __webpack_require__(14);
	
	var _pageTpl2 = _interopRequireDefault(_pageTpl);
	
	var _jqueryNotyPackagedMin = __webpack_require__(15);
	
	var _jqueryNotyPackagedMin2 = _interopRequireDefault(_jqueryNotyPackagedMin);
	...
	function buildPage() {
	    if (location.hash) {
	        ...
	        var container = $('body').find('.articles');
	        container.empty();
	        var pageTemplate = (0, _pageTpl2.default)();
	...
	function setArticleUpdatingState() {
	    var currentArticleEl = $(this).closest('.article');
	    var articleActiveTagsId = getArticleActiveTagsId(currentArticleEl);
	...
	function getArticleActiveTagsId(artileEl) {
	    var tagsList = artileEl.find(".simple-tags__item--active");
	    var tagsIdList = [];
	...
	function updateArticle() {
	    var currentArticleEl = $(this).closest('.article');
	    var articleID = currentArticleEl.data('id');
	    var articleData = {};
	    ...
	    promise.then(function (data) {
	        ...
	        (0, _jqueryNotyPackagedMin2.default)({ text: 'article is updated', type: 'success' });
	    }).catch(function () {
	        (0, _jqueryNotyPackagedMin2.default)({ text: 'updating error', type: 'error' });
	    });
	}
	...
	function updateArticleRequest(articleId, body) {
	    ...
	    var myRequest = new Request(_urlConfig2.default.articleURL.getOne(articleId), requestParams);
	...
	function getAllTagsForArticle(articleEl, activeTagIdList) {
	    var tagContainer = articleEl.find(".simple-tags");
	    tagContainer.empty();
	    var xhr = new XMLHttpRequest();
	    xhr.open('GET', _urlConfig2.default.tagURL.getAll());
	    xhr.send();
	    xhr.onreadystatechange = function () {
	        if (xhr.readyState === 4) {
	            if (xhr.status == 200) {
	                var tagList = JSON.parse(xhr.responseText);
	                ...
	                try {
	                    for (var _iterator3 = tagList[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	                        ...
	                        var tagTpl = (0, _simpleTagTpl2.default)(tag);
	...
	function removeArticleNonSelectedTags(container) {
	    ...
	    try {
	        for (var _iterator4 = tagsList[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	            var tagEl = _step4.value;
	...
	function getArticles() {
	    var self = $(this);
	    var articlesContainer = $('body').find('.articles__list');
	    articlesContainer.empty();
	
	    var promise = fetch(_urlConfig2.default.articleURL.getAll(), { method: 'GET' });
	    promise.then(function (response) {
	        ...
	        try {
	            var _loop = function _loop() {
	                ...
	                article.modified = _helperService2.default.timespanToHumanString(article.modified);
	                articleTemplate = (0, _articleTpl2.default)(article);
	
	                articlesContainer.prepend(articleTemplate);
	                var articleEl = articlesContainer.find('.article[data-id=' + article._id + ']');
	                ...
	                try {
	                    var _loop2 = function _loop2() {
	                        ...
	                        tagPromise.push(new Promise(function (resolve, reject) {
	                            var xhr = new XMLHttpRequest();
	                            xhr.open('GET', _urlConfig2.default.tagURL.getOne(tagId));
	                            xhr.onload = function () {
	                                if (this.status >= 200 && this.status < 300) {
	                                    var _res = JSON.parse(xhr.responseText);
	                                    _res.tag.active = true;
	                                    tagsArr.push(_res.tag);
	                                    resolve();
	                                } else {
	                                    reject();
	                                }
	                    ...
	                    for (var _iterator6 = article.tags[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
	                        _loop2();
	                    }
	                } catch (err) {
	                ...
	                Promise.all(tagPromise).then(function () {
	                    var _iteratorNormalCompletion7 = true;
	                    var _didIteratorError7 = false;
	                    var _iteratorError7 = undefined;
	
	                    try {
	                        for (var _iterator7 = tagsArr[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
	...
	function deleteArticle() {
	    var self = $(this);
	    var articleDOM = self.closest('.article');
	    var articleId = articleDOM.data("id");
	
	    var promise = fetch(_urlConfig2.default.articleURL.getOne(articleId), { method: 'DELETE' });
	    promise.then(function (response) {
	        if (response.status === 200) {
	            return response.json();
	        } else {
	        ...
	        (0, _jqueryNotyPackagedMin2.default)({ text: 'article is deleted', type: 'success' });
	    }).catch(function () {
	        (0, _jqueryNotyPackagedMin2.default)({ text: 'deleted error', type: 'error' });
	    });
	}
	...
	function addArticle() {
	    var self = $(this);
	    var articleData = {};
	    var currentArticle = self.closest('.new-article');
	    ...
	    promise.then(function (data) {
	        ...
	        (0, _jqueryNotyPackagedMin2.default)({ text: 'article is added', type: 'success' });
	    }).catch(function () {
	        (0, _jqueryNotyPackagedMin2.default)({ text: 'adding error', type: 'error' });
	    });
	}
	
	function getArticleSelectedTagsId(artileEl) {
	    var tagsList = artileEl.find(".simple-tags__item--selected");
	    var tagsIdList = [];
	    ...
	    try {
	        for (var _iterator8 = tagsList[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
	...
	function articlePostRequest(body) {
	    return new Promise(function (resolve, reject) {
	        var xhr = new XMLHttpRequest();
	        xhr.open("POST", _urlConfig2.default.articleURL.getAll());
	...
	function getTags() {
	    var self = $(this);
	    var tagsPlace = $('body').find('.whole-tags-container .tags__list');
	    tagsPlace.empty();
	    var xhr = new XMLHttpRequest();
	    xhr.open('GET', _urlConfig2.default.tagURL.getAll());
	    xhr.send();
	    ...
	    xhr.onreadystatechange = function () {
	        if (xhr.readyState === 4) {
	            if (xhr.status == 200) {
	                ...
	                try {
	                    for (var _iterator9 = tagList[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
	                        var tag = _step9.value;
	
	                        var tagTpl = (0, _tagTpl2.default)(tag);
	...
	function createTag(data, tagEl) {
	    $.post(_urlConfig2.default.tagURL.add(), data, tagEl).done(function (data) {
	        (0, _jqueryNotyPackagedMin2.default)({ text: 'article is added', type: 'success' });
	        tagEl.closest(".tags__new").removeClass("tags__new--entering");
	        var tagTpl = (0, _tagTpl2.default)(data.tag);
	        tagEl.closest(".tags").find(".tags__list").append(tagTpl);
	    }).fail(function () {
	        (0, _jqueryNotyPackagedMin2.default)({ text: 'creating error', type: 'error' });
	    });
	}
	...
	function selectArticlesByActiveTag() {
	    var activeTags = $(".active-tags-container .tag");
	    var activeTagsId = [];
	    ...
	    try {
	        for (var _iterator10 = activeTags[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
	...
	function getArticlesByTags(activeTagsId) {
	    ...
	    try {
	        for (var _iterator11 = activeTagsId[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
	            var _tagId = _step11.value;
	
	            var promise = fetch(_urlConfig2.default.articleURL.getByTag(_tagId), { method: 'GET' });
	            promise.then(function (response) {
	                if (response.status === 200) {
	                    return response.json();
	                } else {
	                ...
	                try {
	                    var _loop3 = function _loop3() {
	                        ...
	                        try {
	                            var _loop4 = function _loop4() {
	                                ...
	                                tagPromise.push(new Promise(function (resolve, reject) {
	                                    ...
	                                    xhr.onload = function () {
	                                        if (this.status >= 200 && this.status < 300) {
	                                            var _res2 = JSON.parse(xhr.responseText);
	                                            _res2.tag.active = true;
	                                            tagsArr.push(_res2.tag);
	                                            resolve();
	                                        } else {
	                                            reject();
	                                        }
	                            ...
	                            for (var _iterator13 = article.tags[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
	                                _loop4();
	                            }
	                        } catch (err) {
	                        ...
	                        Promise.all(tagPromise).then(function () {
	                            ...
	                            try {
	                                for (var _iterator14 = tagsArr[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
	...
	function changeTagUpdatingState(e) {
	    ...
	    if ($(this).text() === "save") {
	        ...
	        var tagTitle = $(this).closest(".tag").find(".tag__title").text();
	...
	function updateTag(tagEl) {
	    ...
	    var tagId = $(tagEl).closest(".tag").data("tag-id");
	...
	function updateTagRequest(tagId, data) {
	    $.ajax({
	        url: _urlConfig2.default.tagURL.getOne(tagId),
	        method: "PUT",
	        data: data,
	        crossDomain: true,
	        success: function success() {
	            (0, _jqueryNotyPackagedMin2.default)({ text: 'tag is updated', type: 'success' });
	...
	function tagDeletingHandler() {
	    var self = $(this);
	    var tagId = $(this).closest(".tag").data("tag-id");
	    var xhr = new XMLHttpRequest();
	    xhr.open('DELETE', _urlConfig2.default.tagURL.getOne(tagId));
	    xhr.send();
	    xhr.onreadystatechange = function () {
	        if (xhr.readyState === 4) {
	            if (xhr.status == 200) {
	                (0, _jqueryNotyPackagedMin2.default)({ text: 'tag is deleted', type: 'success' });
	                $('.tag[data-tag-id=\'' + tagId + '\']').remove();
	                selectArticlesByActiveTag();
	            } else {
	                (0, _jqueryNotyPackagedMin2.default)({ text: 'deleting error', type: 'error' });
	            }
	        }
	    };
	}
	...
	function getArticleDetails(articleId) {
	    var articlesContainer = $('body').find('.articles');
	    articlesContainer.empty();
	    $.get(_urlConfig2.default.articleURL.getOne(articleId), function (data) {
	        var article = data.article;
	        article.modified = _helperService2.default.timespanToHumanString(article.modified);
	        var articleTemplate = (0, _articleTpl2.default)(article);
	        ...
	        try {
	            var _loop5 = function _loop5() {
	                ...
	                tagPromise.push(new Promise(function (resolve, reject) {
	                    ...
	                    xhr.onload = function () {
	                        if (this.status >= 200 && this.status < 300) {
	                            var _res3 = JSON.parse(xhr.responseText);
	                            tagsArr.push(_res3.tag);
	                            resolve();
	                        } else {
	                            reject();
	                        }
	            ...
	            for (var _iterator15 = article.tags[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
	                _loop5();
	            }
	        } catch (err) {
	        ...
	        Promise.all(tagPromise).then(function () {
	            ...
	            try {
	                for (var _iterator16 = tagsArr[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/*separator*/\n.topSeparator {\n  border-top: 1px solid #eeeeee;\n}\n.bottomSeparator {\n  border-bottom: 1px solid #eeeeee;\n}\n.leftSeparator {\n  border-left: 1px solid #eeeeee;\n}\n.rightSeparator {\n  border-right: 1px solid #eeeeee;\n}\n/*     backgrounds */\n/*@backgroungImage: */\n/* colors */\n/*  fonts */\n/*  states rules  */\n.display--modify {\n  display: none;\n}\n.article--modify .display--modify {\n  display: block;\n}\n.article--modify .display--show {\n  display: none;\n}\nhtml {\n  width: 100%;\n  height: 100%;\n  font: 12px 'Open Sans', arial, sans-serif;\n}\nbody {\n  width: 100%;\n  height: 100%;\n  display: flex;\n  line-height: normal;\n}\n.main-wrapper {\n  display: flex;\n  flex-direction: row;\n  align-items: stretch;\n  flex: 1 1 auto;\n  min-width: 800px;\n}\n/******aside******/\n.aside {\n  min-width: 180px;\n  max-width: 290px;\n  width: 40%;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-grow: 1;\n  background-image: url(" + __webpack_require__(7) + ");\n}\n.site-logo {\n  width: 40px;\n  height: 40px;\n  display: flex;\n  margin: 15px;\n  background-color: #ffffff;\n}\n.site-logo__text {\n  display: block;\n  margin: auto;\n  color: #777777;\n  font-size: 2.333rem;\n  font-weight: 700;\n}\n.site-nav__link {\n  display: block;\n  padding: 10px 15px;\n  color: #ffffff;\n  font: 12px;\n}\n.aside-footer {\n  color: #ffffff;\n  margin: 20px 0 10px 0;\n  padding: 10px 15px;\n}\n.aside-footer__text {\n  display: block;\n  margin-bottom: 10px;\n  font-size: 24px;\n  font-weight: bold;\n}\n.aside-footer__copyright {\n  display: block;\n  font-size: 12px;\n}\n/*common styles */\n.display--hide {\n  display: none;\n}\n.input-field {\n  box-sizing: border-box;\n  padding: 10px;\n  border-radius: 5px;\n  width: 100%;\n  margin-bottom: 5px;\n}\n.controlButton {\n  font: 1rem courier, courier-new, monospace;\n  padding: 0;\n  color: #777777;\n  border: none;\n  background: inherit;\n}\n.detailsHover,\n.controlButtonHover {\n  color: #23527c;\n  text-decoration: underline;\n  cursor: pointer;\n}\n.control-buttons {\n  display: none;\n}\n.button {\n  font: 1rem courier, courier-new, monospace;\n  padding: 0;\n  color: #777777;\n  border: none;\n  background: inherit;\n}\n.button:hover {\n  color: #23527c;\n  text-decoration: underline;\n  cursor: pointer;\n}\n/* articles block */\n.articles {\n  flex: 1 0 auto;\n  height: 100%;\n  width: 60%;\n  padding: 0 50px;\n  overflow: auto;\n  background: #ffffff;\n}\n.articles__title-container {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: space-between;\n  margin: 50px 0 0;\n  border-top: 1px solid #eeeeee;\n  border-bottom: 1px solid #eeeeee;\n}\n.articles__title {\n  padding: 10px 0;\n  text-transform: uppercase;\n  font-weight: bold;\n  color: #000000;\n}\n.new-article {\n  margin: 10px 0;\n  padding: 20px 0;\n  border-bottom: 1px solid #eeeeee;\n}\n.new-article__headline {\n  padding: 10px 0;\n  text-transform: uppercase;\n  font-weight: bold;\n  color: #000000;\n  text-align: center;\n}\n.new-article .control-buttons {\n  display: flex;\n  justify-content: flex-end;\n}\n.article {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n  padding: 35px 0;\n  border-bottom: 1px solid #eeeeee;\n}\n.article__information {\n  flex-grow: 1;\n}\n.article__title {\n  margin: 10px 0;\n  font-size: 1.5rem;\n  font-weight: bold;\n}\n.article__description {\n  display: inline-block;\n  margin: 10px 0;\n  padding: 5px;\n  font-size: 1rem;\n  border-radius: 5px;\n  color: #aaaaaa;\n  background: #dddddd;\n}\n.article__author-link {\n  width: 70px;\n  min-width: 70px;\n  height: 70px;\n  border-radius: 50%;\n  overflow: hidden;\n  margin-left: 50px;\n}\n.article__details {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  margin: 10px 0;\n  color: #777777;\n}\n.details {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n}\n.details__item {\n  font: 1rem courier, courier-new, monospace;\n  padding: 0 10px;\n  border-left: 1px solid #eeeeee;\n}\n.details__item:first-child {\n  margin-left: 0;\n  padding-left: 0;\n  border-left: none;\n}\n.details__item:last-child {\n  padding-right: 0;\n}\n.details__more-link {\n  color: #777777;\n}\n.details__more-link:hover {\n  color: #23527c;\n  text-decoration: underline;\n  cursor: pointer;\n}\n.article:hover .control-buttons {\n  display: flex;\n}\n.tags {\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap;\n}\n.tags__caption {\n  text-align: center;\n  display: block;\n  width: 100%;\n  margin-bottom: 5px;\n  font-size: 22px;\n}\n.tags__list {\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap;\n}\n.tags__item {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  border-radius: 5px;\n  margin: 5px;\n}\n.tag {\n  cursor: pointer;\n}\n.tag__title {\n  padding: 7px 10px;\n  font-size: 16px;\n}\n.tag__title-input {\n  display: none;\n}\n.tag__ctrl-btns {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  height: 100%;\n  width: 40px;\n  cursor: pointer;\n  font-size: 10px;\n}\n.tag__btn {\n  color: #fff;\n  width: 100%;\n  height: 100%;\n  text-align: center;\n}\n.tag__update-btn {\n  background: #e4a027;\n  border-top-right-radius: 5px;\n}\n.tag__del-btn {\n  border-bottom-right-radius: 5px;\n  background: #f76464;\n}\n.tag__ctrl-btns:first-child {\n  border-bottom: 1px solid #000;\n}\n.tag--updating .tag__title-input {\n  display: block;\n  margin-bottom: 0;\n  border-top-right-radius: none;\n  border-bottom-right-radius: none;\n}\n.tag--updating .tag__title {\n  display: none;\n}\n.whole-tags-container .tag {\n  background: #f4f4f4;\n  border: 1px solid #eeeeee;\n}\n.whole-tags-container .tag--selected {\n  background-color: #6d992a;\n  color: #fff;\n}\n.active-tags-container .tag {\n  background: #6d992a;\n  border: 1px solid #6d9911;\n  border-radius: 5px;\n  margin: 5px;\n  color: #fff;\n}\n.active-tags-container .tag__title {\n  font-size: 12px;\n  padding: 5px;\n}\n.active-tags-container .tag__ctrl-btns {\n  display: none;\n}\n.simple-tags {\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap;\n}\n.simple-tags__item {\n  background: #f4f4f4;\n  padding: 5px;\n  color: black;\n  margin: 0 5px 5px 0;\n  cursor: pointer;\n  border-radius: 5px;\n}\n.simple-tags__item--selected {\n  color: #fff;\n  background: #6d992a;\n  border: 1px solid #6d9911;\n}\n.article-whole-tags-container .tag {\n  background: #6d992a;\n  border: 1px solid #6d9911;\n  border-radius: 5px;\n  margin: 5px;\n  color: #fff;\n}\n.article-whole-tags-container .tag__title {\n  font-size: 12px;\n  padding: 5px;\n}\n.article-whole-tags-container .tag__ctrl-btns {\n  display: none;\n}\n.tags__new {\n  width: 100%;\n}\n.tags__add-btn,\n.tags__new-name {\n  width: 100%;\n  border: 1px solid #eeeeee;\n  border-radius: 5px;\n  padding: 10px 5px;\n  margin: 5px;\n  text-align: center;\n}\n.tags__new-name {\n  display: none;\n  background: #fff;\n}\n.tags__new--entering .tags__add-btn {\n  display: none;\n}\n.tags__new--entering .tags__new-name {\n  display: flex;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "be81b96c257b7871db3e9e7e8e06f7c1.jpg";
...
/***/ function(module, exports) {
	...
	var HelperService = function () {
	    ...
	    _createClass(HelperService, [{
	        key: 'timespanToHumanString',
	        value: function timespanToHumanString(date) {
	
	            var time = new Date() - new Date(date) - 0.5,
	                second = time / 1000,
	                minute = void 0,
	                hour = void 0,
	                day = void 0,
	...
	exports.default = new HelperService();
...
/***/ function(module, exports) {
	...
	exports.default = getArticleTemplate;
...
/***/ function(module, exports) {
	...
	exports.default = getTagTemplate;
...
/***/ function(module, exports) {
	...
	exports.default = getSimpleTagTemplate;
...
/***/ function(module, exports) {
	...
	exports.default = getPageTemplate;
